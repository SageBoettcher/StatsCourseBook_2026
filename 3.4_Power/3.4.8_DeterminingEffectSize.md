...
- *If $\mathcal{H}_a$ is true, the population correlation is $\rho = 0.25$.*

How did we decide to use $\rho = 0.25$ as the effect size for the simulated “correlated population”, and therefore for the power calculation?
