...
As scientists we always work with a **sample** of data, but we are interested in generalising our results to the wider population. 
...
* The **sampling distribution of the mean** is the distribution you would get if you took many different samples of size $n$ from the population and calculated each of our means
