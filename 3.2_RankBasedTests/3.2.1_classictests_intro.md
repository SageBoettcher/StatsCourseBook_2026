...
We previously introduced the concept of null hypothesis testing and the
...
This week, we will cover **non-parametric tests** based on ranks. Next week we will look at the most commonly used **parametric test**, the $t$-test

As a gerneral rule of thumb, parametric tests are more *powerful* (more likely to
