...
This tells us how spread out the data points are for Maths and English - we can see from the histograms above that the data are slightly more spread out for English than Maths (the histogram for English is flatter).
